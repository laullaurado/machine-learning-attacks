...
#Below methods to calculate input features to the FC layer
...
# Shadow Model mimicking target model architecture, for our implementation is different than target
...
class VisionTransformerModel(nn.Module):
    def __init__(self, num_classes, pretrained=True):
        ...
        self.model.heads = nn.Sequential(
            nn.Linear(self.model.heads.head.in_features, num_classes)
        )
